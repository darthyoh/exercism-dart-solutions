...
void simpleTests() {
  test('no matches', () {
    final List<String> result = anagram
        .findAnagrams('diaper', <String>['hello', 'world', 'zombies', 'pants']);
...
void slightlyLessSimpleTests() {
  ...
  test('does not detect anagram subsets', () {
    final List<String> result =
        anagram.findAnagrams('good', <String>['dog', 'goody']);
    expect(result, equals(<String>[]));
  }, skip: true);
  ...
  test('detects three anagrams', () {
    final List<String> result = anagram.findAnagrams('allergy', <String>[
      'gallery',
      'ballerina',
      'regally',
      'clergy',
  ...
  test('detects multiple anagrams with different case', () {
    final List<String> result =
        anagram.findAnagrams('nose', <String>['Eons', 'ONES']);
...
void edgeCaseTests() {
  test('does not detect an anagram if the original word is repeated', () {
    final List<String> result =
        anagram.findAnagrams('go', <String>['go Go GO']);
    expect(result, equals(<String>[]));
  }, skip: true);

  test('anagrams must use all letters exactly once', () {
    final List<String> result =
        anagram.findAnagrams('tapper', <String>['patter']);
    expect(result, equals(<String>[]));
  }, skip: true);

  test('words are not anagrams of themselves (case-insensitive)', () {
    final List<String> result =
        anagram.findAnagrams('BANANA', <String>['BANANA', 'Banana', 'banana']);
    expect(result, equals(<String>[]));
  }, skip: true);

  test('words other than themselves can be anagrams', () {
    final List<String> result =
        anagram.findAnagrams('LISTEN', <String>['Listen', 'Silent', 'LISTEN']);
